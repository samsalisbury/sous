...
pushd sous-server
SOUS_SERVER= SOUS_STATE_LOCATION=/tmp/sous-cli-testing426964092/gdm sous init -v -d
...
SOUS_SERVER= SOUS_STATE_LOCATION=/tmp/sous-cli-testing426964092/gdm sous deploy -cluster left
SOUS_SERVER= SOUS_STATE_LOCATION=/tmp/sous-cli-testing426964092/gdm sous deploy -cluster right
popd
