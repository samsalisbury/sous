...
mkdir -p /var/folders/sp/wllf_wh92p725fl4vz92mrn16vkfds/T/sous-cli-testing071679678/home/go/{src,bin}
GOPATH=/var/folders/sp/wllf_wh92p725fl4vz92mrn16vkfds/T/sous-cli-testing071679678/home/go go get github.com/nyarly/cygnus # cygnus lets us inspect Singularity for ports

### This build gives me trouble in tests...
### xgo does something weird and different with it's dep-cache dir
# GOPATH=/var/folders/sp/wllf_wh92p725fl4vz92mrn16vkfds/T/sous-cli-testing071679678/home/go make linux_build # we need Sous built for linux for the server
go install . #install the current sous project
cp integration/test-registry/git-server/git_pubkey_rsa* ~/dot-ssh/

cd /var/folders/sp/wllf_wh92p725fl4vz92mrn16vkfds/T/sous-cli-testing071679678
