...
type DurationInfo struct {
	...
	DefaultInstanceForType *DurationInfo `json:"defaultInstanceForType"`
	...
	// ParserForType *com.google.protobuf.Parser<org.apache.mesos.Protos$DurationInfo> `json:"parserForType"`
...
func (self *DurationInfo) Populate(jsonReader io.ReadCloser) (err error) {
	return swaggering.ReadPopulate(jsonReader, self)
}

func (self *DurationInfo) Absorb(other swaggering.DTO) error {
	if like, ok := other.(*DurationInfo); ok {
		*self = *like
		return nil
	}
	return fmt.Errorf("A DurationInfo cannot absorb the values from %v", other)
}

func (self *DurationInfo) MarshalJSON() ([]byte, error) {
	return swaggering.MarshalJSON(self)
}

func (self *DurationInfo) FormatText() string {
	return swaggering.FormatText(self)
}

func (self *DurationInfo) FormatJSON() string {
	return swaggering.FormatJSON(self)
}

func (self *DurationInfo) FieldsPresent() []string {
	return swaggering.PresenceFromMap(self.present)
}

func (self *DurationInfo) SetField(name string, value interface{}) error {
	if self.present == nil {
		self.present = make(map[string]bool)
	}
	switch name {
	default:
		return fmt.Errorf("No such field %s on DurationInfo", name)
	...
	case "defaultInstanceForType", "DefaultInstanceForType":
		...
		if ok {
			...
			return fmt.Errorf("Field defaultInstanceForType/DefaultInstanceForType: value %v(%T) couldn't be cast to type *DurationInfo", value, value)
		}
...
func (self *DurationInfo) GetField(name string) (interface{}, error) {
	switch name {
	default:
		return nil, fmt.Errorf("No such field %s on DurationInfo", name)
...
func (self *DurationInfo) ClearField(name string) error {
	if self.present == nil {
		self.present = make(map[string]bool)
	}
	switch name {
...
type DurationInfoList []*DurationInfo

func (self *DurationInfoList) Absorb(other swaggering.DTO) error {
	if like, ok := other.(*DurationInfoList); ok {
		*self = *like
		return nil
	}
	return fmt.Errorf("A DurationInfo cannot absorb the values from %v", other)
...
func (list *DurationInfoList) Populate(jsonReader io.ReadCloser) (err error) {
	return swaggering.ReadPopulate(jsonReader, list)
}

func (list *DurationInfoList) FormatText() string {
	text := []byte{}
...
func (list *DurationInfoList) FormatJSON() string {
