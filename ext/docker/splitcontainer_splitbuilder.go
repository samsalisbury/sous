...
/*
 XXX We should retire this in favor of the functions in runmount_builder.go
 Ultimately, a collection of reusable functions would be a better thing than
 this "drivable" struct.

 DO NOT edit this file without making that refactor. -jdl
*/
